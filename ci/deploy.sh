...
sshpass -p $USER_PASS ssh -o StrictHostKeyChecking=no $USER_NAME@$HOST_NAME 'export KAFKA_HOST='$KAFKA_HOST' && export DB_HOST='$DB_HOST' && docker stack ls stock-'$SERVICE' -c /opt/stock-'$SERVICE'/ci/docker-image-deploy-'$SERVICE'.yml'
