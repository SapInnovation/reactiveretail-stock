...
public class RetailStock implements Stock
{
	...
	@NotNull
	private Map<Long, RetailStockInfo> stock;
	...
	public Map<Long, RetailStockInfo> getStock() {
		return stock;
	}

	public void setStock(Map<Long, RetailStockInfo> stock) {
		this.stock = stock;
	}
	...
	public RetailStock(@NotNull @Size(min = 10, message = "UPC id cannot be so low") Long upc,
			...
			@NotNull Map<Long, RetailStockInfo> stock) {
		super();
		this.upc = upc;
		this.partNumber = partNumber;
		this.productId = productId;
